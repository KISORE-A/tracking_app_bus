...
const WhatsAppIcon = ({ size = 20, color = "#fff" }) => (
    <svg
        ...
        aria-label="WhatsApp"
    >
        <path d="M380.9 97.1C339 55.2 283.2 32 224.1 32c-123 0-223.9 100.9-223.9 224 0 39.1 10.2 77.3 29.6 111L0 480l116.6-30.6c32.2 17.6 68.4 26.9 105.6 26.9h.1c123 0 224-100.9 224-224 0-59.1-23.2-114.9-65.1-156.2zM224.1 438.7c-33.7 0-66.7-9-95.4-26.1l-6.8-4-69.2 18.1 18.5-67.5-4.4-7c-18.5-29.4-28.2-63.3-28.2-98.2 0-101.7 82.8-184.4 184.6-184.4 49.3 0 95.6 19.2 130.4 54.1 34.8 34.9 54 81.3 54 130.5 0 101.8-82.7 184.5-184.5 184.5zm101.2-138.2c-5.5-2.8-32.8-16.2-37.9-18-5.1-1.9-8.8-2.8-12.5 2.8-3.7 5.5-14.3 18-17.6 21.8-3.2 3.7-6.5 4.2-12 1.4-32.7-16.3-54.1-29.1-75.6-66.1-5.7-9.8 5.7-9.1 16.3-30.4 1.8-3.7.9-6.9-.5-9.7-1.4-2.8-12.5-30.1-17.1-41.2-4.5-10.8-9.1-9.3-12.5-9.5-3.2-.2-6.9-.2-10.6-.2-3.7 0-9.7 1.4-14.8 6.9-5.1 5.5-19.4 19-19.4 46.3 0 27.3 19.9 53.7 22.7 57.4 2.8 3.7 39.1 59.7 94.8 83.7 13.2 5.7 23.5 9.1 31.5 11.6 13.2 4.2 25.2 3.6 34.7 2.2 10.6-1.6 32.8-13.4 37.4-26.4 4.6-13 4.6-24.2 3.2-26.4-1.4-2.2-5.1-3.7-10.6-6.5z" />
    </svg>
);

const GmailIcon = ({ size = 18, color = "#fff" }) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
